  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-[2px] flex items-center justify-center z-[100] p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-[90vw] overflow-hidden border border-slate-200 flex flex-col max-h-[95vh]">
        ...
        {/* Form wraps scrollable body + footer so native validation and Enter-to-submit work */}
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          />
                          <p className="text-[10px] text-slate-400 mt-2 italic font-medium">Max 3MB</p>
                          <p className="text-[10px] text-slate-400 mt-1 italic font-medium">Size: 960 X 640</p>
                        </div>
                      </div>
                    </div>
                  </div>
