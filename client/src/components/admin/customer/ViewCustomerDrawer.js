                ...
                <div className="p-6 space-y-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 font-medium">{user.role || "Customer"}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-6">
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-xl border border-slate-100 bg-slate-50/50">
                            ...
                            <div>
                                ...
                                <span className={`inline-block mt-1 px-3 py-1 rounded-full text-xs font-bold ${user.status === "Active" ? "bg-emerald-100 text-emerald-800" : "bg-rose-100 text-rose-800"}`}>{user.status}</span>
                            </div>
                        </div>
