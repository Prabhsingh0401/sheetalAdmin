                ...
                >
                  ...
                  <td className="px-6 py-4">
                    {editableRow === row._id ? (
                      <input
                        type="text"
                        value={editedData.bust}
                        onChange={(e) => handleChange(e, "bust")}
                        className="w-20 px-2 py-1 border rounded-md"
                      />
                    ) : (
                      row.bust
                  ...
                  <td className="px-6 py-4">
                    {editableRow === row._id ? (
                      <input
                        type="text"
                        value={editedData.hip}
                        onChange={(e) => handleChange(e, "hip")}
                        className="w-20 px-2 py-1 border rounded-md"
                      />
                    ) : (
                      row.hip
                  ...
                  <td className="px-6 py-4">
                    {editableRow === row._id ? (
                      <input
                        ...
                        onChange={(e) => handleChange(e, "shoulder")}
                        className="w-20 px-2 py-1 border rounded-md"
                      />
                    ) : (
                      row.shoulder
