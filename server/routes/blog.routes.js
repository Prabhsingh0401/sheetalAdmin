...
router.post("/admin", isAuthenticated, isAdmin, uploadTo("blogs").single("bannerImage"), createBlog);

router.route("/admin/:id")
    .put(isAuthenticated, isAdmin, uploadTo("blogs").single("bannerImage"), updateBlog)
